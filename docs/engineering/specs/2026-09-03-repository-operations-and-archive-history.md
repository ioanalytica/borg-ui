...
Borg ID, and last-seen observation captured by the parent listing. Each
...
Legacy results without observation identities skip deletion until a fresh
listing can report the missing rows safely.
