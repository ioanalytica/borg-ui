    ...
    async def mount_borg_archive(
        ...
        try:
            ...
            try:
                ...
                # subdirectory. Address by aid: when the caller supplies the
                # id - the selector pattern extract and restore checks use.
                # The human-readable name stays on mount point, source label
                # and logs.
                archive_selector = archive_name
                if archive_name and archive_id and (repository.borg_version or 1) == 2:
