...
def drop_consumed_agent_job_output(db: Session, agent_job: AgentJob) -> None:
    ...
    it, and the caller's copy of the result is untouched. Best effort, like
    the browse route's drop of a consumed contents listing: a failed write is
    logged, and the retention pass reduces what is left behind.
    """
