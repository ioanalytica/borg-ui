...
class BackupPlanExecutionService:
    ...
    async def _execute_repository(
        ...
        try:
            ...
            final_status = await self._wait_for_backup(db, operation_id, run_id)
    ...
    async def _wait_for_backup(
        self, db: Session, operation_id: int, run_id: int
    ) -> str:
        ...
        while True:
            try:
                ...
                try:
                    ...
                    # A connection too broken to roll back is replaced on the
                    # next read.
                    pass
